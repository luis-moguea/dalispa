  ...
  return (
    <>
      ...
      <Box p="2em" mx="auto" px="4" mt="6em">
        <Heading textAlign="center">FORRADO EN ACRÍLICO</Heading>
        <Grid
          objectFit="cover"
          templateColumns={
            forraData.length <= 2 ? "repeat(2, 1fr)" : "repeat(2, 1fr)" // 2 columnas si hay 2 imágenes, 3 si hay más
          }
          templateRows={
            forraData.length <= 2 ? "repeat(1, 400px)" : "repeat(4, 200px)" // 1 fila si hay 2 imágenes, 2 filas si hay más, ajustando la altura a 150px
          }
